if (window.theme = window.theme || {}, window.theme = window.theme || {}, theme.Sections = function () {
    ...
    _createInstance: function (b, a) {
        var c = $(b), e = c.attr("data-section-id"), d = c.attr("data-section-type");
...
slate.a11y = {
    ...
    preload: function (a, c) {
        ...
        var e = this.imageSize(a.src), d = this.getSizedImageUrl(b.src, e);
        c ? c(d, b, a) : a.src = d
    ...
    formatMoney: function (a, f) {
        ...
        var b = "", d = /\{\{\s*(\w+)\s*\}\}/, e = f || "${{amount}}";

        function c(a, b, c, d) {
            if (b = b || 2, c = c || ",", d = d || ".", isNaN(a) || null == a) return 0;
            var e = (a = (a / 100).toFixed(b)).split("."), f = e[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + c),
                g = e[1] ? d + e[1] : "";
            return f + g
        }
    ...
    return a.prototype = _.assignIn({}, a.prototype, {
        _getCurrentOptions: function () {
            ...
            var b = this._getCurrentOptions(), a = this.product.variants;
        ...
        if($(window).width() > 768) 
        {
          $('.product-single__title').replaceWith( "<h1 class='product-single__title'>" + $('.option1 input:checked').val() + " " + $('.option2 input:checked').val() + "</h1>" );
          
        }
          else
        {
          $('.product-single__title').replaceWith( "<h1 class='product-single__title'> <span class='type'>TYPE: </span>" + $('.option1 input:checked').val() + " " + $('.option2 input:checked').val() + "</h1>" );
          
        }
        }, _updateImages: function (a) {
            var b = a.featured_image || {}, c = this.currentVariant.featured_image || {};
    ...
    init: function () {
        $('form[action="/search"]').each(function () {
            var a = $(this).find('input[name="q"]'), b = $("#unprod").val();
            a.bind("keyup change", function () {
                var a = $(this).val(), c = $(this).closest("form").find(".search-results");
    ...
    document.referrer && a.length && window.history.length && a.one("click", function (a) {
        a.preventDefault();
        var c = b(document.referrer), d = b(window.location.href);
    ...
    function c(d, a) {
        var e = a.$slider, b = a.$list, c = this.$wrapper, f = this.settings.autoplay;
    ...
    return {
        init: function () {
            ...
            "#recover" === window.location.hash && a(), $("#RecoverPassword").on("click", function (b) {
                ...
                b.preventDefault(), a()
            }), $(".reset-password-success").length && $("#ResetSuccess").removeClass("hide"), (b = $("#AddressNewForm")).length && (Shopify && new Shopify.CountryProvinceSelector("AddressCountryNew", "AddressProvinceNew", {hideElement: "AddressProvinceContainerNew"}), $(".address-country-option").each(function () {
                ...
                var a = $(this), b = a.data("form-id"), c = a.data("confirm-message");
    ...
    var b = {zoom: 14}, c = null, d = [], e = theme.mapKey ? theme.mapKey : "";
    ...
    return a.prototype = _.assignIn({}, a.prototype, {
        createMap: function () {
            ...
            return (a = f, c = $.Deferred(), d = new google.maps.Geocoder, e = a.data("address-setting"), d.geocode({address: e}, function (b, a) {
    ...
    function a(b) {
        this.container = b;
        var c = this.$container = $(b), a = c.attr("data-section-id");
        this.settings = {
            ...
            delegate: ".mfp", removalDelay: 300, callbacks: {
                beforeOpen: function () {
            ...
            var b = $(this).attr("data-val"), c = $(this).attr("data-no"), d = $(this).text();
            ...
            var a = $(this).attr("href").split("?")[0].split("."), b = a.pop(),
                c = a.pop().replace(/_[a-zA-Z0-9@]+$/, ""), d = a.join(".") + "." + c + "." + b;
        ...
        _stringOverrides: function () {
            ...
            if ($(this.selectors.productThumbImages).length) {
                ...
                $(this.selectors.productThumbImages).on("click", function (d) {
                    d.preventDefault();
                    var b = $(this), c = b.attr("href"), e = b.data("zoom");
            ...
            var a = this.selectors.productImageWrap, d = !this.settings.bpSmall && this.settings.zoomEnabled;
            ...
            if (a) {
                if ($(this.selectors.productPrices).removeClass("visibility-hidden").attr("aria-hidden", "true"), void 0 != a.unit_price ? ($("[data-unit-price]").html(theme.Currency.formatMoney(a.unit_price, theme.moneyFormat)), $("[data-unit-base]").html(a.unit_price_measurement.reference_value + a.unit_price_measurement.reference_unit), $(".price__unit").removeClass("hide")) : $(".price__unit").addClass("hide"), a.available) {
                    var b = $("#pvr-" + a.id).text(), d = $("#quantity_message").data("qty");
            ...
            if ($(this.selectors.originalPrice).html(theme.Currency.formatMoney(a.price, theme.moneyFormat)), a.compare_at_price > a.price) {
                ...
                var b = a.compare_at_price - a.price, d = 100 * b / a.compare_at_price;
    ...
    var a = {}, b = {}, c = {}, d = {mediaGroup: "[data-product-single-media-group]", xrButton: "[data-shopify-xr]"};
    ...
    return {
        init: function (g, h) {
            a[h] = {loaded: !1}, g.forEach(function (a, g) {
                var i = a.getAttribute("data-media-id"), e = a.querySelector("model-viewer"),
    ...
    var a = {link: "link", script: "script"}, b = {requested: "requested", loaded: "loaded"}, c = {
        modelViewerUiStyles: {
    ...
    $.ajax({
        ...
        }, url: $(this).attr("href"), success: function (a) {
            $.magnificPopup.open({
                items: {
    ...
    function a(g) {
        var a, f, h = (this.$container = $(g)).attr("data-section-id"), i = this.wrapper = ".quotes-wrapper",
            d = $(this.slider = "#Quotes-" + h, i), e = !1;
    ...
    return a.prototype = _.assignIn({}, a.prototype, {
        onUnload: function () {
            ...
            var c = b.$list, a = $(this.wrapper, this.$container);
    ...
    var c = (this.$container = $(b)).attr("data-section-id"), a = this.slideshow = "#Slideshow-" + c;
    $(a).each(function () {
        $(this)
    ...
    onUnload: function () {
        ...
        var b = $(this.slideshow), c = $(".slideshow__slide--" + a.detail.blockId + ":not(.slick-cloned)"),
    ...
    var a = this.$container = $(b), c = a.attr("data-section-id");
    a.attr("data-section-timeout"), $(document).on("change", "#SortBySt", function (b) {
        ...
        var b = $(this).data("view"), c = document.URL.split("?"), a = location.search.split("view=");
        ...
        var a = $(".sidebar_tags").data("url"), b = window.location.search.substring(1), d = $("input.optTag"), c = [];
        (d.each(function () {
        ...
        var a = "//" + window.location.hostname + window.location.pathname, b = $("#CollectionFiltersForm").serialize();
        ajaxfilter(a + "?" + b)
        ...
        $.ajax({
            type: "GET", url: a, data: {}, beforeSend: function () {
                ...
                $(".productList .grid-products").html($(".productList .grid-products", b.responseText).html()), $(".filters-toolbar__product-count").html($(".filters-toolbar__product-count", b.responseText).html()), $(".sidebar_tags").html($(".sidebar_tags", b.responseText).html()), $(".active-facets").html($(".active-facets", b.responseText).html()), $(".pagination").html($(".pagination", b.responseText).html()), $(".pagination", b.responseText).html() ? $(".pagination").show() : $(".pagination").hide(), $(".infinitpaginOuter").html($(".infinitpaginOuter", b.responseText).html()), $(".infinitpaginOuter", b.responseText).html() || $(".infinitpagin").remove(), theme.mlcurrency && currenciesChange("sapn.money"), $("body").removeClass("loading hideOverly"), loadMoreBtn(), $(".spr-badge").length > 0 && $.getScript(window.location.protocol + "//productreviews.shopifycdn.com/assets/v4/spr.js"), productGridView(c), setTimeout(function () {
                    productGridView(c)
                }, 1e3), $(".prRange").length && priceSlider(), $("#sideProdSlider").length && $("#sideProdSlider").slick(), history.pushState({page: a}, a, a)
            }
        })
        ...
        $(window).on(a, function () {
            ...
            if ($(".infinitpagin a.infinite").length) {
                var c = $(".infinitpagin").offset(), d = $(document).scrollTop() + $(window).height() - 50;
        ...
        a.length && $.ajax({
            type: "GET", dataType: "html", url: a, beforeSend: function () {
    ...
    var a = this.$container = $(b), d = a.attr("data-section-id"), c = a.attr("data-act"), e = a.attr("data-count"),
        f = a.attr("data-ds"), g = a.attr("data-tb"), h = a.attr("data-mb");
    $.ajax({
    ...
    var b = this.$container = $(c), a = b.attr("data-section-id"), d = $(b).find(".carousel"),
        e = this.tabs = "#" + a + " .tablink", j = this.tabcontent = "#" + a + " .tab-content";
    if ($(e).on("click", function (c) {
        ...
        var f = b.data("baseUrl"), g = b.data("productId"), h = b.data("limit"),
    ...
    var a = this.$container = $(b), e = a.attr("data-section-id"), c = this.masonary = $(a).find(".grid-masonary");
    ...
    drawerTimeout:{
        ...
        $(document).on("click touch", ".quickShop", function (a) {
            ...
            var b = $(this).attr("href"), c = $(this).parents(".grid-view-item").find(".grid-view_image"),
                d = $(this).parents(".grid-view-item").find(".shopWrapper");
            $.ajax({
                url: b, dataType: "html", type: "GET", beforeSend: function () {
            ...
            if (a.preventDefault(), a.stopImmediatePropagation(), theme.ajax_cart) {
                var c = $(this).attr("id"), d = $(this).attr("rel");
                b(c, d)
                ...
                $(document).on("click touchend", ".product-form__cart-submit", function (e) {
                    if (e.preventDefault(), "disabled" != $(this).attr("disabled") && !0 != a) {
                        ...
                        $('[name="selling_plan"]').each(function () {
                            var a = $(this).attr("name"), b = $(this).val();
                            f[a] = b
                        }), $('[name*="properties"]').each(function () {
                            var a = $(this).attr("name").split("[")[1].split("]")[0], b = $(this).val();
                            f[a] = b
                        }), b(c, d, f)
                    }
        ...
        }(), a = "wishlistList", $(document).on("click", ".addto-wishlist", function (e) {
            e.preventDefault();
            var c = $(this).attr("rel");
            if (null == $.cookie(a)) var b = "__" + c; else if (-1 == $.cookie(a).indexOf(c)) {
                var b = $.cookie(a) + "__" + c;
                b = b.replace("____", "__")
            }
            $.cookie(a, b, {
    ...
    function c() {
        ...
        $('.mini-products-list .priceRow.Nanobag').each(function()
        {
        ...
        console.log("number of items in cart: " + cartItemsNum);

        // Get all the hidden paragraphs inside the discount bar
  var discountParagraphs = document.querySelectorAll("#discountBar p.hidden");

  // Separate variables for each data-discount-amount
  var discountAmount1, discountAmount2, discountAmount3, discountAmount4, discountAmount5;
 var selector1, selector2, selector3, selector4, selector5;
  // Loop through each paragraph and assign the discountAmount to the respective variable
  discountParagraphs.forEach(function (paragraph, index) {
   
      var discountAmount = parseInt(paragraph.getAttribute("data-discount-amount"));

    
var selector = "p.hidden:nth-child(" + (index + 1) + ")"; // Selector for the current paragraph

    // Assign the discountAmount to the respective variable based on the index
    switch (index) {
      case 0:
      ...
      case 1:
        ...
        break;
      case 2:
        discountAmount3 = discountAmount;
        selector3 = selector;
        break;
      case 3:
        discountAmount4 = discountAmount;
        selector4 = selector;
        break;
      case 4:
        discountAmount5 = discountAmount;
        selector5 = selector;
        break;
      // Add more cases if you have more paragraphs
    }
  });
      if(cartItemsNum >= discountAmount1)
      {
        
  document.getElementById("discountBar").classList.add("show"); 
        console.log("show discount bar");
      }
      else
      {
  document.getElementById("discountBar").classList.remove("show"); 
      }
if(cartItemsNum >= discountAmount5 && discountAmount5>0)
 {
  document.getElementById("discountBar5").classList.add("show");
   console.log("#discountBar1");
  document.getElementById("discountBar2").classList.remove("show");
  document.getElementById("discountBar3").classList.remove("show");
  document.getElementById("discountBar4").classList.remove("show");
  document.getElementById("discountBar1").classList.remove("show");
        console.log("show discount bar text 5");
 }
      else if (cartItemsNum >= discountAmount4 && discountAmount4>0)
      {
        
  document.getElementById("discountBar1").classList.remove("show");
  document.getElementById("discountBar2").classList.remove("show");
  document.getElementById("discountBar5").classList.remove("show");
  document.getElementById("discountBar3").classList.remove("show");  
        document.getElementById("discountBar4").classList.add("show");
        console.log("show discount bar text 4");
      }
      else if (cartItemsNum >= discountAmount3 && discountAmount3>0)
      {
  ...
  document.getElementById("discountBar4").classList.remove("show");
  document.getElementById("discountBar5").classList.remove("show");  
        document.getElementById("discountBar3").classList.add("show");
        console.log("show discount bar text 3");
      }
      else if (cartItemsNum >= discountAmount2 && discountAmount2>0)
      {
  ...
  document.getElementById("discountBar3").classList.remove("show");
  document.getElementById("discountBar5").classList.remove("show");  
        document.getElementById("discountBar2").classList.add("show");
        console.log("show discount bar text 2");
      }
      else if (cartItemsNum >= discountAmount1 && discountAmount1>0)
      {
  ...
  document.getElementById("discountBar3").classList.remove("show");
  document.getElementById("discountBar4").classList.remove("show");  
        document.getElementById("discountBar1").classList.add("show");
        console.log("show discount bar text 1");
      }
      else
      {
  document.getElementById("discountBar").classList.remove("show"); 
    ...
    function d() {
        var b = "wishlistList";
        try {
            if (null != $.cookie(b) && "__" != $.cookie(b) && "" != $.cookie(b)) for (var c = String($.cookie(b)).split("__"), a = 0; a < c.length; a++) "" != c[a] && ($('.wishlist[rel="' + c[a] + '"]').removeClass("addto-wishlist").find("span").text(theme.wlAvailable), $('.wishlist[rel="' + c[a] + '"] .ad').removeClass("ad-heart-l").addClass("ad-heart"), $(".favCount").text(a).removeClass("hide"))
        } catch (d) {
        }
    }
    ...
    $(document).on("click", ".currencyOpt", function (a) {
        ...
        var b = $(this), a = $(this).data("date"), c = new Date(a).getTime(), d = setInterval(function () {
            var i = new Date().getTime(), a = c - i, e = Math.floor(a / 864e5), f = Math.floor(a % 864e5 / 36e5),
                g = Math.floor(a % 36e5 / 6e4), h = Math.floor(a % 6e4 / 1e3);
        ...
        var c = $(this).parent(".qtyField"), a = $(c).find(".qty").val(), b = 1;
        $(this).is(".plus") ? b = parseInt(a) + 1 : a > 1 && (b = parseInt(a) - 1), $(c).find(".qty").val(b)
    }), $(document).on("click", ".gridSwatches li:not(.noImg)", function (d) {
        var e = $(this), a = $(this).attr("rel"), b = $(this).parents(".grid-view-item").find(".grid-view-item__link");
...
//   $('.swatch.option1 .swatch-element .swatchLbl').change();
//    var variantType=$(this).text().toLowerCase();
//   if(variantType==="pack")
//   {
//   console.log(variantType);
//     $("#7155004571784-0-pack").prop("checked", true);
// $("#7155004571784-0-pack").change();
//     $("#7155004571784-1-burgundy").prop("checked", true);
// $("#7155004571784-1-burgundy").change();
// $("#7155004571784-1-burgundy").click();
//   }
//   else
//   {
    
//   console.log("other")
//   $('#7155004571784-1-blue').prop("checked", true);
//   $('#7155004571784-1-blue').change();
//   }
...
if($(window).width() < 766)
  {
    $('.product-single__price').appendTo(".product-form ");
  }
...
window.addEventListener("load", (event) => {
  ...
  const carabiners = document.querySelectorAll('.Carabiner .qtyField');
                    if(carabiners)
                    {
...
$('.option1 .swatch-element input').change(function(e){
  $('.productDescription').hide();
